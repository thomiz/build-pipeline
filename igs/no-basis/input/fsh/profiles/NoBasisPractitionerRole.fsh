...
* ^status = #active
* ^date = "2019-05-20"
* practitioner only Reference(Practitioner or NoBasisPractitioner)
* organization only Reference(Organization or NoBasisOrganization)
...
* healthcareService only Reference(HealthcareService or NoBasisHealthcareService)
